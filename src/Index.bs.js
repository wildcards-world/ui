...
ReactDOMRe.renderToElementWithId(React.createElement(WildcardsProvider.make, {
          getGraphEndpoints: (function (networkId, param) {
              if (networkId !== 4) {
                if (networkId !== 5) {
                  return {
                          mainnet: Globals.$pipe$pipe$pipe$pipe(process.env.REACT_APP_MAINNET_BE, "https://api.wildcards.world/v1/graphq"),
                          matic: Globals.$pipe$pipe$pipe$pipe(process.env.REACT_APP_MATIC_BE, "https://matic.graph.wildcards.world/subgraphs/name/wildcards-world/wildcards-matic"),
                  ...
                  return {
                          ...
                          matic: Globals.$pipe$pipe$pipe$pipe(process.env.REACT_APP_MATIC_TESTNET, "https://mumbai.graph.wildcards.world/subgraphs/name/wildcards-world/wildcards-matic"),
                          ws: "wss://api.thegraph.com/subgraphs/name/wildcards-world/wildcards-goerli"
                        };
                }
              } else {
                return {
                        mainnet: Globals.$pipe$pipe$pipe$pipe(process.env.REACT_APP_RINKEBY_BE, "https://rinkeby.api.wildcards.world/v1/graphq"),
                        matic: Globals.$pipe$pipe$pipe$pipe(process.env.REACT_APP_MATIC_TESTNET_ALT, "https://api.thegraph.com/subgraphs/name/wildcards-world/wildcards-testnet"),
                        ws: "wss://api.thegraph.com/subgraphs/name/wildcards-world/wildcards-goerli"
                      };
              }
            }),
