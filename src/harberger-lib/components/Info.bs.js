...
function Info$SimpleView(Props) {
  ...
  var orgLink = React.createElement("a", {
      ...
      }, Globals$WildCards.restr(orgName));
  return React.createElement(React.Fragment, {
              children: null
                    ...
                    optMonthlyPledgeEth !== undefined ? optMonthlyPledgeEth + (" " + unit) : "Loading"
                            ...
                            return " the " + species;
                          })) + "."))), daysHeld !== undefined ? React.createElement("p", undefined, userLink, " has been the guardian of " + (tokenName + (" for " + (daysHeld[0].toFixed() + " days "))), definiteTime !== undefined ? React.createElement(React.Fragment, undefined, "and has enough deposit to last ", React.createElement(CountDown$WildCards.make, {
...
function Info(Props) {
  ...
  var match = Globals$WildCards.mapd(QlHooks$WildCards.useRemainingDepositEth(chain, currentPatron), [
        "Loading",
        "Loading"
      ], (function (a) {
          return [
  ...
  var match$1 = Globals$WildCards.mapd(QlHooks$WildCards.useAmountRaisedToken(chain, tokenId), [
        "Loading",
        "Loading"
      ], (function (a) {
          return [
  ...
  var priceString = typeof currentPriceWei === "number" ? "Loading" : Web3Utils$WildCards.fromWeiBNToEthPrecision(currentPriceWei._0, 2) + (" " + unit);
...
function Info$Auction(Props) {
  ...
  var clearAndPush = RootProvider$WildCards.useClearNonUrlStateAndPushRoute(undefined);
  var currentUsdEthPrice = UsdPriceProvider$WildCards.useUsdPrice(undefined);
  var match = Globals$WildCards.mapd(QlHooks$WildCards.useAmountRaisedToken(chain, tokenId), [
        "Loading",
        "Loading"
      ], (function (a) {
          return [
