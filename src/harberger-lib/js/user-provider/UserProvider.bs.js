...
function useDisplayName(ethAddress) {
  ...
  var opt3box = Globals.$less$$great(Js_dict.get(userContext.userInfo, ethAddressLower), (function (a) {
          return a.threeBox;
        }));
  var opt3boxName = Globals.$great$great$eq(Globals.$great$great$eq(opt3box, (function (a) {
              return a.profile;
            })), (function (a) {
          return a.name;
        }));
  return Belt_Option.mapWithDefault(opt3boxName, Belt_Option.mapWithDefault(Globals.$less$$great(Globals.$great$great$eq(Globals.$great$great$eq(opt3box, (function (a) {
