...
type initParams = {
  @dead("initParams.environment") environment: string,
  @dead("initParams.apiKey") apiKey: string,
  // Description: Your Transak API Key.
  // Example Value: 4fcd6904-706b-4aff-bd9d-77422813bbb7
  // Default Value:
  @dead("initParams.hostURL") hostURL: string,
  ...
  // Default Value:
  @dead("initParams.cryptoCurrencyCode") cryptoCurrencyCode: option<string>,
  ...
  // Example Value: CDAI
  // Default Value: ETH
  @dead("initParams.defaultCryptoCurrency") defaultCryptoCurrency: option<string>,
  ...
  // Example Value: CDAI
  // Default Value:
  @dead("initParams.cryptoCurrencyList") cryptoCurrencyList: option<string>,
  ...
  // Example Value: USDT"
  // Default Value:
  @dead("initParams.networks") networks: option<string>,
  ...
  // Default Value:
  @dead("initParams.walletAddress") walletAddress: option<string>,
  ...
  // Default Value:
  @dead("initParams.walletAddressesData") walletAddressesData: option<walletAddressesData>,
  ...
  // Example Value:
  // Default Value:
  @dead("initParams.fiatCurrency") fiatCurrency: option<string>,
  // Description: The code of the fiat currency you want the customer to buy/sell cryptocurrency.
  // Example Value: INR
  // Default Value:
  @dead("initParams.countryCode") countryCode: option<string>,
  ...
  // Example Value: IN
  // Default Value:
  @dead("initParams.fiatAmount") fiatAmount: option<int>,
  ...
  // Example Value: 1100
  // Default Value:
  @dead("initParams.defaultNetwork") defaultNetwork: option<string>,
  ...
  // Example Value: matic
  // Default Value:
  @dead("initParams.defaultFiatAmount") defaultFiatAmount: option<int>,
  ...
  // Example Value: 1100
  // Default Value:
  @dead("initParams.paymentMethod") paymentMethod: option<string>,
  ...
  // Default Value:
  @dead("initParams.defaultPaymentMethod") defaultPaymentMethod: option<string>,
  ...
  // Example Value: upi Open this document to see more examples
  // Default Value:
  @dead("initParams.disablePaymentMethods") disablePaymentMethods: option<string>,
  ...
  // Example Value: upi Open this document to see more examples"
  // Default Value:
  @dead("initParams.email") email: option<string>,
  ...
  // Default Value:
  @dead("initParams.userData") userData: option<userData>,
  ...
  // Example Value:
  // Default Value:
  @dead("initParams.partnerOrderId") partnerOrderId: option<string>,
  ...
  // Default Value:
  @dead("initParams.partnerCustomerId") partnerCustomerId: option<string>,
  ...
  // Default Value:
  @dead("initParams.accessToken") accessToken: option<string>,
  ...
  // Default Value:
  @dead("initParams.redirectURL") redirectURL: option<string>,
  ...
  // Default Value:
  @dead("initParams.disableWalletAddressForm") disableWalletAddressForm: option<bool>,
  ...
  // Example Value: TRUE
  // Default Value: FALSE
  @dead("initParams.isAutoFillUserData") isAutoFillUserData: option<bool>,
  ...
  // Example Value: TRUE
  // Default Value: FALSE
  @dead("initParams.themeColor") themeColor: option<string>,
  ...
  // Example Value: TRUE
  // Default Value: FALSE
  @dead("initParams.isDisableCrypto") isDisableCrypto: option<bool>,
  ...
  // Example Value: TRUE
  // Default Value: FALSE
  @dead("initParams.isFeeCalculationHidden") isFeeCalculationHidden: option<bool>,
