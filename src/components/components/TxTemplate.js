...
export default ({ txObjects, children }) =>
  txObjects.length > 0 ? (
    <div style={{ margin: "1em" }}>
      <Heading.h3>
        Processing Transaction <WildcardsLoader />
      </Heading.h3>
      {!!txObjects[0] ? (
        <Fragment>
          {(() => {
            switch (txObjects[0].status) {
              ...
              case "error":
                return (
                  <Text>The transaction was failed, please try again.</Text>
                );
              case "success":
                return (
                  <Fragment>
                    ...
                    <Text>
                      It has been confirmed in the blockchain
                      {/*txObjects[0].confirmations.length*/}.
                    </Text>
                    <Text>
                      <a
                        href={
